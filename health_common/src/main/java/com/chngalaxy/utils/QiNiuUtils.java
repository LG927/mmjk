...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "KXY8AkYH604jxOlLBxexj-o6eNEb4em_a1QJQLEj";
    private static final String SECRETKEY = "xOw70QXAsv_GHlC-We0pOqIoQz24TVsyN_I_1jLZ";
    // 对象仓库
    private static final String BUCKET = "sz119";
    public static final String DOMAIN= "http://qzof7mmi5.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
        uploadFile("C:\\Users\\Lenovo\\Desktop\\quickstart\\pics\\5.png","sbt.jpg");
        //removeFiles("1.png","sbt.jpg");
        //listFile();
    }
