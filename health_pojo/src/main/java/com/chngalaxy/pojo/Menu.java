...
public class Menu implements Serializable{
    ...
    private Set<com.chngalaxy.pojo.Role> roles = new HashSet<com.chngalaxy.pojo.Role>(0);//角色集合
    ...
    public Set<com.chngalaxy.pojo.Role> getRoles() {
        return roles;
    }

    public void setRoles(Set<com.chngalaxy.pojo.Role> roles) {
        this.roles = roles;
    }
